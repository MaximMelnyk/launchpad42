...
`ft_putnbr` -- це одна з перших функцій, яку запитають на examshell Piscine. Це класика рівня 0-1 екзамену. Якщо ти не можеш її написати за 10 хвилин без підказок -- ти ще не готовий.
