...
Зверни увагу: у Norminette оголошення та присвоєння повинні бути **окремими рядками**. Тобто `int nb = 42;` — заборонено. Спочатку оголоси, потім присвой. Всі оголошення — на початку функції.
